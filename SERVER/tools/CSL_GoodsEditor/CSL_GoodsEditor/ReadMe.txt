================================================================================
    MICROSOFT 基础类库： CSL_GoodsEditor 项目概述
===============================================================================

应用程序向导已为您创建了此 CSL_GoodsEditor 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 CSL_GoodsEditor 应用程序的每个文件的内容摘要。

CSL_GoodsEditor.vcproj
...
CSL_GoodsEditor.h
    ...
    CCSL_GoodsEditorApp 应用程序类。

CSL_GoodsEditor.cpp
    这是包含应用程序
    类 CCSL_GoodsEditorApp 的主应用程序源文件。
...
res\CSL_GoodsEditor.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 CSL_GoodsEditor.rc 中。

res\CSL_GoodsEditor.rc2
    此文件包含不由 Microsoft 
...
CSL_GoodsEditorDoc.h、CSL_GoodsEditorDoc.cpp - 文档
    这些文件包含 CCSL_GoodsEditorDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CCSL_GoodsEditorDoc::Serialize）。
CSL_GoodsEditorView.h、CSL_GoodsEditorView.cpp - 文档视图
    这些文件包含 CCSL_GoodsEditorView 类。
    CCSL_GoodsEditorView 对象用于查看 CCSL_GoodsEditorDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 CSL_GoodsEditor.pch 的预编译头文件 (PCH)
