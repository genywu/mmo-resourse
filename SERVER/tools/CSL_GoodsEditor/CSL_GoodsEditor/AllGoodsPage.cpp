...
{	
	...
	///m_cAllGoodsList.InsertColumn(8,"XSIZE",LVCFMT_LEFT,60);
	//m_cAllGoodsList.InsertColumn(9,"YSIZE",LVCFMT_LEFT,60);
	m_cAllGoodsList.InsertColumn(9,"物品类别",LVCFMT_LEFT,100);
	m_cAllGoodsList.InsertColumn(10,"拾取声音",LVCFMT_LEFT,60);
	//m_cAllGoodsList.InsertColumn(12,"重量",LVCFMT_LEFT,60);
	...
	//m_cAllGoodsList.InsertColumn(17,"武器动作类型",LVCFMT_LEFT,100);	
...
{
	//char str[512] = "";
	//sprintf(str,"%d",pGoods->dwIndex);
	//ChangeItemText(pGoods->dwIndex,0,str);

	//strcpy(str,pGoods->strOrigName.c_str());
	//ChangeItemText(pGoods->dwIndex,1,str);

	//strcpy(str,pGoods->strName.c_str());
	//ChangeItemText(pGoods->dwIndex,2,str);

	//ChangeItemText(pGoods->dwIndex,3,pGoods->bSave==1?"是":"否");

	//sprintf(str,"%d",pGoods->dwIconId);
	//ChangeItemText(pGoods->dwIndex,4,str);

	//sprintf(str,"%d",pGoods->dwGroundId);
	//ChangeItemText(pGoods->dwIndex,5,str);

	//sprintf(str,"%d",pGoods->dwEquipID);
	//ChangeItemText(pGoods->dwIndex,6,str);

	//sprintf(str,"%d",pGoods->dwValue);
	//ChangeItemText(pGoods->dwIndex,7,str);

	//ChangeItemText(pGoods->dwIndex,8,const_cast<char*>(strGoodType[pGoods->dwType]));

	//sprintf(str,"%d",pGoods->dwSound);
	//ChangeItemText(pGoods->dwIndex,9,str);

	//strcpy(str,pGoods->strContent.c_str());
	//ChangeItemText(pGoods->dwIndex,10,str);
	int i=0;
	vector<tagGoodAttr>::iterator iter;	
	for(iter=vecGoodAttr.begin();iter!=vecGoodAttr.end();iter++,i++)
	{			
