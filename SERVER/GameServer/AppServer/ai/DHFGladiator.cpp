...
BOOL CDHFGladiator::WhenBeenHurted( LONG lAttackerType, const CGUID &attackerID, DWORD dwHurt )
{
...
BOOL CDHFGladiator::SearchEnemy()
{
	if( !CanSearchEnemy() )
	{
		return FALSE;
...
void CDHFGladiator::SetTarget( LONG lType, const CGUID &TargetGUID )
{
