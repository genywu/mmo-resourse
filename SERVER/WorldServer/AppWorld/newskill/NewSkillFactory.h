...
public:
	...
	//载入各个等级的静态参数
	static void				LoadLevelStatiParam( TiXmlElement *pElem, CNewSkill::tagSkill *pSkill,map<string,string>	mpVarablist);
	static void				LoadCommonConfig( TiXmlElement *pElem, CNewSkill *pNewSkill,CNewSkill::tagSkill *ptgSkill,map<string,string> mpVarablist);
	static void				LoadNewLevelConfigration( TiXmlElement *pElem, CNewSkill *pNewSkill);
	//载入各个等级的状态技能
	static void				LoadLevelConfigration( TiXmlElement *pElem, CNewSkill *pNewSkill, DWORD dwLevel, map<string,string>	mpVarablist);
	//载入公式配置
	...
	//载入基本属性条件
	static void				LoadPropertyCondition(TiXmlElement *pElem,CNewSkill::tagConProperty *ptgConProperty,CNewSkill::tagSkill *ptgSkill);
	//载入物品条件
	static void				LoadGoodCondition(TiXmlElement *pElem,CNewSkill::tagConGood *ptgConGood,CNewSkill::tagSkill *ptgSkill);
	//状态条件
	static void				LoadBuffCondition(TiXmlElement *pElem,CNewSkill::tagConBuff *ptgConBuff,CNewSkill::tagSkill *ptgSkill);
	//技能条件
	static void				LoadSkillCondition(TiXmlElement *pElem,CNewSkill::tagConSkill *ptgConSkill,CNewSkill::tagSkill *ptgSkill);
	//距离条件
	static void				LoadDistanceCondition(TiXmlElement *pElem,CNewSkill::tagConDistance *ptgConDistance,CNewSkill::tagSkill *ptgSkill);
	//载入事件
	static void				LoadEventCondition(TiXmlElement *pElem,CNewSkill::tagConEvent *ptgConEvent,CNewSkill::tagSkill *ptgSkill);
	//载入阻挡
	static void				LoadBlockCondition(TiXmlElement *pElem,CNewSkill::tagConBlock *ptgConBlock,CNewSkill::tagSkill *ptgSkill);
	//载入职业条件
	static void				LoadOccupationCondition(TiXmlElement *pElem,CNewSkill::tagConOccupation *ptgConOccupation,CNewSkill::tagSkill *ptgSkill);
	//载入时间条件
	static void				LoadTimerCondition(TiXmlElement *pElem,CNewSkill::tagConTimer *ptgTimer,CNewSkill::tagSkill *ptgSkill);
	//载入面条件
	static void				LoadFaceCondition(TiXmlElement *pElem,CNewSkill::tagConFace *ptgFace, CNewSkill::tagSkill *ptgSkill);
	//载入场景条件
	static void				LoadRegionCondition(TiXmlElement *pElem,CNewSkill::tagConRegion *ptgRegion,CNewSkill::tagSkill *ptgSkill);
	//载入对象
	static void				LoadValidObject(TiXmlElement *pElem,CNewSkill::tagConValidObject *ptgConValidObject,CNewSkill::tagSkill *ptgSkill);
	//载入脚本
	static void				LoadScript(TiXmlElement *pElem,CNewSkill::tagConScript *ptgConScript,CNewSkill::tagSkill *ptgSkill);
	//载入条件组
