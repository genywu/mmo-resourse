...
public:
	...
	void CPlayerFriendToCDBFriendGroup(const CGUID &PlayerGuid, CEntityGroup*pBaseEntityOwner); 
	void CDBFriendGroupToCPlayerFriend(const CGUID &PlayerGuid, CEntityGroup*linkmanGroupOwner, CEntityGroup*linkmanGroupAim); 
	...
	void DetailQuestIndexCDBPlayerToCPlayer	(CEntityGroup* pBaseEntity, CPlayer* player);
	void DetailLotteryCDBPlayerToCPlayer	(CEntityGroup* pBaseEntity, CPlayer* player);
	...
	void DetailQuestIndexCPlayerToCDBPlayer	(CPlayer* player, CEntityGroup* pBaseEntity);
	void DetailLotteryCPlayerToCDBPlayer	(CPlayer* player, CEntityGroup* pBaseEntity);
	...
	// 玩家的设置的功能映射热键
	void DetailFuncHotKeyCPlayerToCDBPlayer( CPlayer *pPlayer, CEntityGroup *pBaseEntity );
	void DetailFuncHotKeyCDBPlayerToCPlayer( CEntityGroup *pBaseEntity, CPlayer *pPlayer );
...
public:
	...
	void CreateLoadLinkmanSession(const CGUID& guid);
