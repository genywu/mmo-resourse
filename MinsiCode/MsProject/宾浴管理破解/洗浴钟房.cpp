                     ...
                     INT nShowCmd)
{
    ...
    do
    {
        ...
        if ((EXCEPTION_DEBUG_EVENT == DebugEvent.dwDebugEventCode) && (EXCEPTION_BREAKPOINT == DebugEvent.u.Exception.ExceptionRecord.ExceptionCode) && (con.Eip < 0x70000000))
        {
            ...
            ::VirtualProtectEx(g_ProcessInfo.hProcess, (LPVOID)0x009E6E6C, NumberOfBytesWritten, PAGE_EXECUTE_READWRITE, &g_dwflOldCheckProtect);
            ::WriteProcessMemory(g_ProcessInfo.hProcess, (LPVOID)0x009E6E6C, &s_Code, NumberOfBytesWritten, &NumberOfBytesWritten);
            ::VirtualProtectEx(g_ProcessInfo.hProcess, (LPVOID)0x009E6E6C, NumberOfBytesWritten, g_dwflOldCheckProtect, &g_dwflOldCheckProtect);
...
BOOL InitProcess(VOID)
{
    ...
    TCHAR* strProcessName = _T("ZFClient.exe");
