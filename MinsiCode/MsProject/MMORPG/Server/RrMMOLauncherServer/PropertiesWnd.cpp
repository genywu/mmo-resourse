...
VOID CPropertiesWnd::InitPropList()
{
    ...
    pGroup1 = new CMFCPropertyGridProperty(_T("外观"));

    pGroup1->AddSubItem(new CMFCPropertyGridProperty(_T("三维外观"), (_variant_t) false, _T("指定窗口的字体不使用粗体，并且控件将使用三维边框")));

    pProp = new CMFCPropertyGridProperty(_T("边框"), _T("Dialog Frame"), _T("其中之一: 无(None)、细(Thin)、可调整大小(Resizable)、对话框外框(Dialog Frame)"));
    ...
    pSize = new CMFCPropertyGridProperty(_T("窗口大小"), 0, TRUE);
    ...
    pGroup2 = new CMFCPropertyGridProperty(_T("字体"));
    ...
    pGroup3 = new CMFCPropertyGridProperty(_T("杂项"));
    ...
    pGroup4 = new CMFCPropertyGridProperty(_T("层次结构"));

    pGroup41 = new CMFCPropertyGridProperty(_T("第一个子级"));
    pGroup4->AddSubItem(pGroup41);

    pGroup411 = new CMFCPropertyGridProperty(_T("第二个子级"));
