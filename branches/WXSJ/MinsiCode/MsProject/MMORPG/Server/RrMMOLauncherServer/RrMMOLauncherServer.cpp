...
// RrMMOLauncherServer.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CRrMMOLauncherServerApp, CWinAppEx)
    ON_COMMAND(ID_APP_ABOUT, &CRrMMOLauncherServerApp::OnAppAbout)
    // 基于文件的标准文档命令
...
// CRrMMOLauncherServerApp 构造

CRrMMOLauncherServerApp::CRrMMOLauncherServerApp()
{
...
// 唯一的一个 CRrMMOLauncherServerApp 对象

CRrMMOLauncherServerApp theApp;
...
// CRrMMOLauncherServerApp 初始化

BOOL CRrMMOLauncherServerApp::InitInstance()
{
    ...
    pDocTemplate = NEW CMultiDocTemplate(IDR_RRMMOSIMPLECLIETYPE,
        RUNTIME_CLASS(CRrMMOLauncherServerDoc),
        RUNTIME_CLASS(CChildFrame), // 自定义 MDI 子框架
        RUNTIME_CLASS(CRrMMOLauncherServerView));
    if (!pDocTemplate)
        return FALSE;
...
// 用于运行对话框的应用程序命令
VOID CRrMMOLauncherServerApp::OnAppAbout()
{
    CAboutDlg aboutDlg;
    aboutDlg.DoModal();
}

// CRrMMOLauncherServerApp 自定义加载/保存方法

VOID CRrMMOLauncherServerApp::PreLoadState()
{
    BOOL bNameValid;
    CString strName;
...
VOID CRrMMOLauncherServerApp::LoadCustomState()
{
}

VOID CRrMMOLauncherServerApp::SaveCustomState()
{
}

// CRrMMOLauncherServerApp 消息处理程序
