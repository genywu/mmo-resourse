...
namespace RrTetris
{
    ...
    // DllGame初始化对象
    static CMsBaseRun*  gs_pCMsBaseRun = NULL;

    // DllGame消息钩子函数
    static BOOL MSCALL RrTetrisHookProc(MSG*);

    // DllGame窗口消息回调
    static LRESULT CALLBACK RrTetrisWndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
