...
// 空闲处理
VOID CMsClientNetManager::OnThreadFreeWork(VOID)
{
    return;
}

// 停止之前
BOOL CMsClientNetManager::ForeStop(VOID)
{
    return m_lpCMsIocpManager->Stop(TRUE);
}

// 消息处理
VOID CMsClientNetManager::OnThreadMsgExecute(LPMSG lpMsg)
{
    // 消息通知
