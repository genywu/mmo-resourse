...
enum ATTRIBUTEINFO_TYPE
{
	...
	AINFOTYPE_ATTACK_FLUCTUATION=33,	//攻击力浮动
...
enum ENUM_DETAIL_ATTRIB
{
	...
	DETAIL_ATTRIB_ATTACKCOLD,			//冰攻击
	DETAIL_ATTRIB_DEFENCECOLD,			//冰防御
	DETAIL_ATTRIB_ATTACKFIRE,			//火攻击
	DETAIL_ATTRIB_DEFENCEFIRE,			//火防御
	DETAIL_ATTRIB_ATTACKLIGHT,			//电攻击
	DETAIL_ATTRIB_DEFENCELIGHT,			//电防御
	DETAIL_ATTRIB_ATTACKPOISON,			//毒攻击
	...
	DETAIL_ATTRIB_RMB,				//活力
	DETAIL_ATTRIB_BANK_RMB,			//活力上限
...
enum ENUM_CHAR_ATT
{
	...
	CHAR_ATT_ATTACK_COLD,		// 冰攻击
	CHAR_ATT_DEFENCE_COLD,		// 冰防御

	CHAR_ATT_ATTACK_FIRE,		// 火攻击
	CHAR_ATT_DEFENCE_FIRE,		// 火防御

	CHAR_ATT_ATTACK_LIGHT,		// 电攻击
	CHAR_ATT_DEFENCE_LIGHT,		// 电防御

	CHAR_ATT_ATTACK_POISON,		// 毒攻击
	CHAR_ATT_DEFENCE_POISON,	// 毒防御
