...
LUAPLUS_INLINE LuaPlus::LuaObject LuaState::GetGlobal(const char *name)
{
	return GetGlobals()[name];
}

LUAPLUS_INLINE LuaPlus::LuaObject LuaState::GetRegistry()
{
	return LuaPlus::LuaObject(this, LUA_REGISTRYINDEX);  //{  lua_getregistry(m_state);
}
