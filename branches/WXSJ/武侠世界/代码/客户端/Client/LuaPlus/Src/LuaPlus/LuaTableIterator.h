...
bool LUA_API LuaPlusH_next(LuaState* state, LuaPlus::LuaObject* table, LuaPlus::LuaObject* key, LuaPlus::LuaObject* value);
...
public:
	...
	**/
	inline LuaTableIterator( LuaPlus::LuaObject& tableObj, bool doReset = true ) :
		m_isDone(false),
		m_tableObj(tableObj),
	...
	**/
	...
	/**
		\return Returns a LuaPlus::LuaObject describing the current key.
	**/
	inline LuaPlus::LuaObject& GetKey()
	{
		// This function is only active if Reset() has been called head.
		luaplus_assert( IsValid() );
	...
	/**
		\return Returns a LuaPlus::LuaObject describing the current value.
	**/
	inline LuaPlus::LuaObject& GetValue()
	{
		// This function is only active if Reset() has been called head.
		luaplus_assert( IsValid() );
