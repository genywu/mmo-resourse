...
LuaPlus::LuaObject LuaState::GetGlobals() throw()
{
	return LuaPlus::LuaObject( this, gt(m_state) );
}
...
LUA_API bool LuaPlusH_next(LuaState* state, LuaPlus::LuaObject* table, LuaPlus::LuaObject* key, LuaPlus::LuaObject* value)
{
