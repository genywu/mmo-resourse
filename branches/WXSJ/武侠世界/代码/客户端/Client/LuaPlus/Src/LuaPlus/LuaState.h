...
public:
	...
	int Equal(const LuaPlus::LuaObject& o1, const LuaPlus::LuaObject& o2);
	int LessThan(const LuaPlus::LuaObject& o1, const LuaPlus::LuaObject& o2);
	...
	bool DumpObject(const char* filename, const char* name, LuaPlus::LuaObject& value, unsigned int flags = DUMP_ALPHABETICAL,
					int indentLevel = 0, unsigned int maxIndentLevel = 0xffffffff);
	bool DumpObject(const char* filename, LuaPlus::LuaObject& key, LuaPlus::LuaObject& value, unsigned int flags = DUMP_ALPHABETICAL,
					int indentLevel = 0, unsigned int maxIndentLevel = 0xffffffff);

	bool DumpObject(LuaStateOutFile& file, const char* name, LuaPlus::LuaObject& value, unsigned int flags = DUMP_ALPHABETICAL,
					int indentLevel = 0, unsigned int maxIndentLevel = 0xffffffff);
	bool DumpObject(LuaStateOutFile& file, LuaPlus::LuaObject& key, LuaPlus::LuaObject& value, unsigned int flags = DUMP_ALPHABETICAL,
					int indentLevel = 0, unsigned int maxIndentLevel = 0xffffffff);
	...
	LuaPlus::LuaObject* GetHeadObject()			{  return (LuaPlus::LuaObject*)&m_headObject;  }
	LuaPlus::LuaObject* GetTailObject()			{  return (LuaPlus::LuaObject*)&m_tailObject;  }
...
protected:
	...
	bool CallFormatting(LuaPlus::LuaObject& tableObj, LuaStateOutFile& file, int indentLevel,
...
{
public:
	LuaFunction(LuaPlus::LuaObject& functionObj) :
...
{
public:
	LuaFunctionVoid(LuaPlus::LuaObject& functionObj) :
		m_functionObj(functionObj)
	{
		luaplus_assert(m_functionObj.IsFunction());
	}
...
namespace LPCD
{
	...
	inline void Push(lua_State* L, LuaPlus::LuaObject& value)				{  (void)L; value.PushStack();  }
	...
	inline LuaPlus::LuaObject		Get(TypeWrapper<LuaPlus::LuaObject>, lua_State* L, int idx)
		{  return LuaPlus::LuaObject(LuaState::CastState(L), idx);  }
} // namespace LPCD
