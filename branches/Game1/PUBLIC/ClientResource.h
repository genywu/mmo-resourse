...
//#ifdef _CLENTTOTEST_
//	static map<string, DWORD> s_mapNotFoundFiles;			//没有找到的文件<路径, ID>
//#endif
...
public:
	...
	bool	AddFile(string& strFileName,BYTE* pBuf,long lSize);							//从缓冲区一个文件	
...
private:
	...
	void	SearchOneFile(tagFileInfo* pParenttagInfo,CHAR* strPath,
							string& strFileName,DWORD dwSize);							//搜索子文件
