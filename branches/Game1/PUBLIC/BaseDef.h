...
//////////////////////////////////////////////////////////////////
	...
	P_ATTR_RANKOFNOBILITY,
	P_ATTR_RANKOFNOBCREDIT,
	P_ATTR_BATAKCREDIT,
	P_ATTR_ZANDOCREDIT,//赞多狩猎声望
	P_ATTR_MEDALSCORES,
	P_ATTR_RANKOFMERCENARY,
	P_ATTR_MERCENARYCREDIT,
	P_ATTR_COUNTRY,
...
//! 通用物品容器的最大格子数
const DWORD MAX_ALLPURPOSE_CONTAINER_SIZE = 4;
//! 阵营类型
enum eCampType
{
	eCampUnion  = 0, // 联邦
...
enum eRegionPkType
{
	eRPT_DisallowPk,		//! 不许PK
	eRPT_AllowPk,			//! 允许PK
	eRPT_ShowCampPk,		//! 阵营PK显示，这个值现在只用于客户端显示
	eRPT_DisallowTeamPk,	//! 不许PK队友
};
