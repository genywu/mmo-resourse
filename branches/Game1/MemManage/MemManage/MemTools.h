...
//!					异步释放内存（自定义信息）
#define				M_FREE_INFO(Param_Pointer, Param_Size, Param_Info)				__FREE_INFO__((Param_Pointer), (Param_Size), (Param_Info))

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//! 被内存池管理的对象
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//! 所有继承自CMemObject的对象，在创建时都应放弃系统提供的new关键字而调用MP_NEW，否则在不同的编译条件下，可能会产生严重错误
#define				MP_NEW															__NEW__
//! 关于DELETE的定义，只作为统一行为用，实际使用中，与系统提供的delete关键字功能毫无区别
