...
:m_dwDataChanged(eFDCF_All)
{
	...
	m_UnionBaseData.CreateTime = time(NULL); //! 创建时间
	if(NULL == pMaster)
		throw;
	...
	LONG lSize = strlen(pMaster->GetMasterName());
