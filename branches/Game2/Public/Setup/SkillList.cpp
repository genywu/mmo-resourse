...
// 添加到CByteArray
bool CSkillList::AddToByteArray(vector<uchar>* pByteArray)
{
...
// 解码
bool CSkillList::DecordFromByteArray(uchar* pByte, long& pos)
{
	Release();
...
{
	for(map<DWORD, CSkillList::tagSkill>::iterator it=m_mapSkillList.begin();
		it!=m_mapSkillList.end(); it++)
	{
