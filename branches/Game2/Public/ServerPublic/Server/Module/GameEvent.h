...
enum eChildObjType
{
	...
	ChildObjType_ShapeMove,      /// 玩家/宠物移动
    ChildObjType_Budhism,        /// 技能的佛学系统
    ChildObjType_ClearDry,       /// 清空燥的定时器
};

//定时器中(void* var)参数结构
struct tagTimerVar
{
	tagTimerVar(){lvar=0;lvar1=0;pvar=NULL;}
...
public:
	...
	//超时响应
	virtual long OnTimeOut(ulong timerid,ulong curtime,const void* var)=0;
	//当定时器被取消的调用
	virtual void OnTimerCancel(ulong timerid,const void* var)=0;
	//处理实体间消息函数
