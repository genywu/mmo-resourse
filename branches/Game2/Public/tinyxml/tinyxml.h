...
protected:
	...
	*/
	...
	inline static const char* GetChar( const char* p, char* _value, int* length, TiXmlEncoding encoding )
	{
		...
		{
			*length = utf8ByteTable[ *((const uchar*)p) ];
	...
	static int IsAlpha( uchar anyByte, TiXmlEncoding encoding );
	static int IsAlphaNum( uchar anyByte, TiXmlEncoding encoding );
	...
	static void ConvertUTF32ToUTF8( ulong input, char* output, int* length );
...
public:
    ...
    */
    const char * Attribute( const char * name,const char *node) const;
...
public:
	...
	*/
	...
	// Load memory data.
	bool LoadData(const uchar* pszData,int length, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING);
