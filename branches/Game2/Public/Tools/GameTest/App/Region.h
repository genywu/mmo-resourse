...
protected:
	...
	tagCellObject* m_pCellObj;				//格子上的Obj数据
	/////////////////////////////////////////////////////////////////////
	// 地图属性接口
	/////////////////////////////////////////////////////////////////////
public:
	...
	// 阻挡设置
	void SetBlock(int x, int y, BYTE b)
	{
		if( x>-1 && x<GetWidth() && y>-1 && y<GetHeight())
		{
			m_pCell[GetWidth()*y+x].bBlock = b;
		}
	}
	...
	{
		if (x>-1&&GetWidth()&&y>-1&&y<GetHeight())
		{
			tagCellObject* pCellObj = &m_pCellObj[GetWidth()*y + x];
	...
	CRegion::tagCell* GetCellData()	{return m_pCell;}
