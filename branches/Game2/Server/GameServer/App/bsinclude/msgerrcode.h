...
#ifndef _MSG_ERRCODE_H_
#define _MSG_ERRCODE_H_
...
enum    //数据格式非法错误码
{
    ...
    //GS路由
    GSACTIONUNDEF          = -210001,  //未定义的客户端动作，即action不为'1'和'2'

    //统一对战的类型错误码
	USERTYPEERROR          = -211001,  //帐户类型错误
	PAYTYPENUMERROR        = -211002,  //支付类型数量错误
	ITEMTYPENUMERROR       = -211003,  //道具数量错误
	TRADETYPENUMERROR      = -211004,  //交易数量错误
	USERTYPENUMERROR       = -211005,  //用户数量错误
	TRANSFERTYPEERROR      = -211006,  //转帐类型错误
	REMITTYPEEERROR        = -211007,  //划帐类型错误
	CONTEXTTYPEEERROR      = -211008,  //该局对局情况错误
	AUTHTYPEEERROR         = -211009,  //授权类型错误
	CONTEXTIDERROR         = -211010,  //订单号码错误
	CONTEXTINDICATIONERROR = -211011,  //该局状态错误
	LOGSTATUSERROR         = -211012,  //登陆类型错误
	TRANSFERNUMERROR       = -211013,  //转帐数量错误
	REMITNUMERROR          = -211014,  //划帐数量错误
...
enum   //lbs业务处理错误
{
    ...
    LBSUNAUTHOR_OPERATION  = -400003,  //未授权的请求包类型
    LBSDB_PROC_MSG_DELAY   = -400004,  //消息发送给CBS 处理消息延迟
};
