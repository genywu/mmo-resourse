...
enum
{
	...
	SOCKLOCALFAILED	  = -1004,	//本地初始化SOCKET失败
	SNDBUF_OVERFLOW	  = -1005,  //发送缓存满
	RCVBUF_OVERFLOW	  = -1006,  //接收缓存满
	TMOBUF_OVERFLOW	  = -1007,	//超时缓存满
	LSOCKDISCONNECT	  = -1008,  //通讯异常		
    ...
    ITEMLOGINITFAILD   = -6005,
    ITEMGATHERSTARTFAILD= -6006,  //启动道具采集客户端失败
