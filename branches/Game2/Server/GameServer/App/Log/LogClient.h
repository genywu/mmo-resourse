...
#include "../../../../Public/ServerPublic/Log/LogDef.h"
...
private:        
	...
	*/
	...
	//!	文件写入线程
	static	unsigned __stdcall	FileWriteThread(void* pThis);  
...
public:
    ...
    long    GetClientNo()   { return m_lClientNo; }
