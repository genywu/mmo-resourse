...
public:
	...
	float* GetDiedLostGoods(CPlayer* pBeKilledPlayer,long lMurdererType,const CGUID& MurdererID,CServerRegion* pRegion,
						CRegion::eSecurity SecurityType,long lNameColor);//得到死亡掉落的物品的概率															//得到死亡的爆率
	//攻击方和被攻击方的的判断
