...
//BOOL CCollection::AddEvent(eChildObjType dwType,DWORD dwTime)
//{
//	if (m_lTimerID!=-1)	return FALSE;
//
//	tagTimerVar* pTimvar =  GameManager::GetInstance()->GetTimerVar();//new tagTimerVar;
//	pTimvar->TimerType = dwType;
//	m_lTimerID=GameManager::GetInstance()->Schedule(this,(void*)pTimvar,timeGetTime()+dwTime);
//	return TRUE;
//}

//BOOL CCollection::LogoutEvent(LONG lTimerID)
//{
//	if (m_lTimerID!=lTimerID)
//	{
//		return FALSE;
//	}
...
//BOOL CCollection::DeleteEvent(LONG lTimerID)
//{
//	if (m_lTimerID != lTimerID)
//	{
//		return FALSE;
...
void CCollection::AddDiedEvent()
{
	...
	m_lDiedEvent=GameManager::GetInstance()->Schedule(this,(void*)pTimvar,timeGetTime()+GlobalSetup::GetSetup()->dwCollectionKeepDeadTime);
	return ;
}
