...
#pragma warning (pop)
	...
	*/
	...
	void render::Interface::Layer2D::OutPutText(int iX,int iY,const char *pszString,int iLen,D3DCOLOR color, int iStyleIndex, float fScale)
	{
...
#pragma warning (disable: 4018)
			for (size_t i = 0; i < dwusedmatrixcount;i++)
#pragma warning (pop)
			{
...
#pragma warning (pop)
	...
	void render::Interface::Layer3D::ShaderGroup::ReSet(void)
	{
		...
		for (DWORD i = 0; i < GetShaderCount();i++)
		{
...
#pragma warning (pop)
	...
	void render::Interface::Layer3D::ShaderGroup::_tagShader::Rend(DWORD dwrendtype)
	{
		...
		for (DWORD i = 0 ; i < dynamicusenum ; i++)
		{
		...
		for (DWORD i = 0 ; i < lightdynamicusenum ; i++)
		{
