...
const char *pszGridVisibleEditStatusName[] = {"设置","删除"};

ToolGridVisibleEdit::ToolGridVisibleEdit(void)
{
...
void ToolGridVisibleEdit::Create()
{
}

void ToolGridVisibleEdit::Destroy(void)
{
}
...
void ToolGridVisibleEdit::MessageProc(BOOL bActive)
{
	//切换
...
void ToolGridVisibleEdit::Render()
{
	DrawBrush();	
	_ShowStatus();
}
...
void ToolGridVisibleEdit::_ShowStatus(void)
{
	render::Interface *pInterface = render::Interface::GetInstance();
