...
public:
	...
	//virtual BOOL QueryGoodsPosition(DWORD dwHashValue, DWORD& dwPosition);
	...
	//virtual CBaseObject* Find(DWORD dwHashCode);
	virtual CBaseObject* Find(const CGUID& guid);

	//##ModelId=41AF080B038A
	//virtual CBaseObject* Remove(DWORD dwHashCode, LPVOID pVoid = NULL);
