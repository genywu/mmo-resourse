...
public:
	...
	enum WORLD_SESSION_STEP_DEF
	{
        ...
        WORLD_SESSION_LOAD_AGENT_ORDERS,
        WORLD_SESSION_SAVE_AGENT_ORDERS
	};
	...
	void SendSaveLinkman(CEntityGroup* pEntity);
	void ProcessSaveLinkmanMsg(long retFlag, CEntityGroup* pEntity);
    ...
    // AH AgentOrders
    void SendLoadAgentOrdersMsg();
    void SendSaveAgentOrdersMsg();
	...
	//void SendInsertOnlineMailMsg(const CGUID& ownerID, CMail* mail);
	// 在线玩家删除信件
	...
	// 非在线玩家添加信件
	//void SendInsertOfflineMailsMsg(CMail* mail);
	// 系统删除非在线玩家信件
	//void SendSystemDeleteOfflineMailsProcMsg(long lCurTime);
	// Ban Player proc
