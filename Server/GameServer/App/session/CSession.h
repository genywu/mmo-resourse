...
public:
	...
	{
		tagParam(void)
			:minPlugs(0),maxPlugs(0),lifeTime(0)
		{
	...
	//void SendNotification(const char* strMsg, DWORD dwColor = 0xffffffff);
	/***********************************************************************/
	/*  zhaohang 2010-11-8 fix 直接将颜色加入字符串*/
	/***********************************************************************/
	void SendNotification(const char* strMsg);
