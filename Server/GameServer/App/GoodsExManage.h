...
#include "../../../Public/Setup/GoodsExSetup.h"
...
public:
	//!				响应物品分解预览请求
	//void			OnDisassemblePreview(CMessage *pMsg);
...
public:
	//!				响应物品合成预览请求
	//void			OnSynthesizePreview(CMessage *pMsg);
...
public:
	...
	////！			获得武器的吟唱时间加成时间比例
	//float			GetAmendIT(CGoods *pArm);
	////！			获得武器的其他效果比例
	//float			GetAmendAtt(CGoods *pArm);
...
public:
	...
	//!				系统设置物品的冻结属性
	//static	long	SetGoodsFrostProperty_System(CGoods *pGoods, long lFrostType);
