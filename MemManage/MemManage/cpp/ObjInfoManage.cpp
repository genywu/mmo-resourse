...
namespace XM_Tools
{
	...
	CObjInfoManage::~CObjInfoManage(void)
	{
		...
		{
			for (stdext::hash_map<unsigned long, tagObjRunInfo>::iterator ite = m_mapObjInfo.begin(); m_mapObjInfo.end() != ite; ++ite)
			{
	...
	{
		stdext::hash_map<unsigned long, tagObjRunInfo>::iterator ite = m_mapObjInfo.find(uRTID);
