...
public:
    ...
    */
    ...
    void addRegion( const wxString& name, const wxRect& dim ,const wxPoint &OffsetPoint);
    void deleteRegion( const wxString& name );
    void deleteAllRegions();
    void setRegionArea( const wxString& name, const wxRect& dim, const wxPoint &OffsetPoint, const bool evt_src = false );
...
private:
    ...
    WX_DECLARE_STRING_HASH_MAP( RectEx, mapNamedRegion );
