...
/**
**/
inline bool LuaPlus::LuaObject::operator==(const LuaPlus::LuaObject& right) const
{
...
/**
**/
inline LuaState* LuaPlus::LuaObject::GetState() const
{
	return m_state;
}


inline lua_State* LuaPlus::LuaObject::GetCState() const
{
	return m_state->m_state;
}


inline LuaPlus::LuaObject::operator lua_State*() const
{
	return m_state->m_state;
}


inline LuaPlus::LuaObject::operator LuaState*() const
{
	return m_state;
}


inline LuaCall::LuaCall(LuaPlus::LuaObject& functionObj) :
...
inline LuaCall& operator<<(LuaCall& call, LuaPlus::LuaObject& value)
{
	value.PushStack();
	call.m_numArgs++;
	return call;
