...
bool LuaState::CallFormatting(LuaPlus::LuaObject& tableObj, LuaStateOutFile& file, int indentLevel,
...
static void WriteKey(LuaStateOutFile& file, LuaPlus::LuaObject& key)
{
	if (key.IsNumber())
	{
		char keyName[255];
...
**/
bool LuaState::DumpObject(LuaStateOutFile& file, LuaPlus::LuaObject& key, LuaPlus::LuaObject& value,
...
/**
	Writes a Lua object to a text file.
**/
bool LuaState::DumpObject(LuaStateOutFile& file, const char* name, LuaPlus::LuaObject& value,
						 unsigned int flags, int indentLevel, unsigned int maxIndentLevel)
{
...
**/
bool LuaState::DumpObject(const char* filename, LuaPlus::LuaObject& key, LuaPlus::LuaObject& value,
						 unsigned int flags, int indentLevel, unsigned int maxIndentLevel)
{
	if (!key.IsString())
	{
...
/**
	Save the complete script state.
**/
bool LuaState::DumpObject(const char* filename, const char* name, LuaPlus::LuaObject& value,
						 unsigned int flags, int indentLevel, unsigned int maxIndentLevel)
{
	// Open the text file to write the script state to.
	LuaStateOutFile regFile;
...
int LuaState::Equal(const LuaPlus::LuaObject& o1, const LuaPlus::LuaObject& o2)
{
...
int LuaState::LessThan(const LuaPlus::LuaObject& o1, const LuaPlus::LuaObject& o2)
{
...
LuaPlus::LuaObject LuaState::NewUserDataBox(void* u)
{
