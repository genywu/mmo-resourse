...
public:
	...
	LuaObject(const LuaPlus::LuaObject& src) throw();
	LuaObject(const LuaStackObject& src) throw();
	LuaObject& operator=(const LuaPlus::LuaObject& src) throw();
...
/*	template <typename T>
	...
	/**
		Retrieves the LuaState object associated with this LuaPlus::LuaObject.
	**/
	...
	bool operator==(const LuaPlus::LuaObject& right) const;
	bool operator<(const LuaPlus::LuaObject& right) const;
	...
	void SetMetaTable(const LuaPlus::LuaObject& valueObj);

	int GetN();
	void SetN(int n);

	void Insert(LuaPlus::LuaObject& obj);
	void Insert(int index, LuaPlus::LuaObject& obj);
	...
	LuaPlus::LuaObject& SetWString(LuaPlus::LuaObject& key, const lua_WChar* value);
	LuaPlus::LuaObject& SetUserData(const char* key, void* value);
	LuaPlus::LuaObject& SetUserData(int key, void* value);
	LuaPlus::LuaObject& SetUserData(LuaPlus::LuaObject& key, void* value);
	LuaPlus::LuaObject& SetLightUserData(const char* key, void* value);
	LuaPlus::LuaObject& SetLightUserData(int key, void* value);
	LuaPlus::LuaObject& SetLightUserData(LuaPlus::LuaObject& key, void* value);
	LuaPlus::LuaObject& SetObject(const char* key, LuaPlus::LuaObject& value);
	LuaPlus::LuaObject& SetObject(int key, LuaPlus::LuaObject& value);
	LuaPlus::LuaObject& SetObject(LuaPlus::LuaObject& key, LuaPlus::LuaObject& value);
	...
	void AssignObject(LuaPlus::LuaObject& value);		// Should this function be removed??
	...
	LuaPlus::LuaObject GetByObject(const LuaPlus::LuaObject& obj);
	...
	LuaPlus::LuaObject operator[](const LuaPlus::LuaObject& obj);
...
protected:
	...
	LuaPlus::LuaObject& SetTableHelper(LuaPlus::LuaObject& key, lua_TObject& valueObj);
};
...
{
public:
	LuaCall(LuaPlus::LuaObject& functionObj);
...
LuaCall& operator<<(LuaCall& call, LuaPlus::LuaObject& value);
