...
void FindFile(const char* strFile, list<string>* plistFileName);	// 读取所有的文件
...
/* 
*功能：字符串字符串替换
*细节描述： 将源字符串source中指定字符串sub替换为rep
*参数： source	源字符串
		sub 指定字符串
*		rep		指定长度替换字符串
*返回值： 替代后字符串
