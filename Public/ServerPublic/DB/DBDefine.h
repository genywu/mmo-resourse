...
{
	DB_ATTR_DATA_BYTE = 0,	// 1 uchar
	DB_ATTR_DATA_WORD,		// 2 uchar
	DB_ATTR_DATA_DWORD,		// 4 uchar
	DB_ATTR_DATA_FLOAT,		// 4 uchar
	DB_ATTR_DATA_LONG,		// 4 uchar
	DB_ATTR_DATA_SHORT,		// 2 uchar
	DB_ATTR_DATA_CHAR,		// 1 uchar
	DB_ATTR_DATA_BOOL,		// 1 uchar
	DB_ATTR_DATA_BUF,		// N uchar(或特定值uchar)

	DB_ATTR_DATA_BYTEARRAY, // 1 uchar * M个数
	DB_ATTR_DATA_WORDARRAY,	// 2 uchar * M个数
	DB_ATTR_DATA_DWORDARRAY,// 4 uchar * M个数
	DB_ATTR_DATA_FLOATARRAY,// 4 uchar * M个数
	DB_ATTR_DATA_LONGARRAY,	// 4 uchar * M个数
	DB_ATTR_DATA_SHORTARRAY,// 2 uchar * M个数
	DB_ATTR_DATA_CHARARRAY,	// 1 uchar * M个数
	DB_ATTR_DATA_BOOLARRAY,	// 1 uchar * M个数
	DB_ATTR_DATA_BUFARRAY	// N uchar(或特定值uchar) * M个数
};
...
enum PLAYER_EXTEND_ID
{
	...
	PEI_YUANBAO,						//元宝
	PEI_JIFEN,							//积分
	PEI_MEDAL_CONTAINER_CONTAINER,
    PEI_EQUIP_GOD,                      // 法宝装备栏 天字
    PEI_EQUIP_LAND,                     //  地字
    PEI_EQUIP_HUMAN,                    //  人字
