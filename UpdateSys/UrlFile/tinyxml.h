...
public:
	...
	*/
	...
	static void SetLanguage(CURRENT_LANGUAGE e)		{ s_eLanguage = e; }		//设定当前语言环境
...
protected:
	static CURRENT_LANGUAGE s_eLanguage;		//语言设置(0-中国,1-韩国,2-日本)
...
public:
	...
	const char*		Value();//		{ return value.c_str(); }		///< Return the value of this attribute.
	#ifdef TIXML_USE_STL
...
public:
	...
	void operator=( TiXmlElement& base );
	...
	*/
    ...
    /*
       Include the error msg attribute
    */
    const char * Attribute( const char * name,const char *node);
...
public:
	...
	*/
	...
	// Load memory data.
	bool LoadData(const unsigned char* pszData,int length, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING);
...
public:
	...
	virtual bool VisitEnter( TiXmlElement& element, const TiXmlAttribute* firstAttribute );
	virtual bool VisitExit( TiXmlElement& element );

	virtual bool Visit( const TiXmlDeclaration& declaration );
	virtual bool Visit( TiXmlText& text );
	virtual bool Visit( TiXmlComment& comment );
	virtual bool Visit( TiXmlUnknown& unknown );
